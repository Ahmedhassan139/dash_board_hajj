...
,
'روتانا خليجية','mbc', 'RT online', 'شمس FM', 'CNN Indonesia', 'قناة المملكة' , 'قناة الجزيرة' , 'إذاعة جدة' , 'ميديا وان تي في' , 'أخبار قناة السعودية' , 'رادیو بین المللی عربستان سعودی_ بخش فارسی' , 'اتحاد اذاعات وتليفزيونات دول منظمةالتعاون الإسلامي' , 'إذاعة ألف ألف', 'قناة اقرأ الفضائية', 'روتانا خليجية']
