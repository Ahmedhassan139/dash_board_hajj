 ...
 'فاطمة المالكي',
            ...
            with st.spinner(' جاري تحضير التقرير! انتطر من فضلك...'):
                ...
                if button_news:
                    ...
                    news_paper_results2=news_paper_results2.rename({'url': 'الرابط' , 'indexed' : 'التاريخ', 'title_snippet' : 'الخير' , 'extra_source_attributes.name' : 'اسم الجريدة' , 'extra_author_attributes.world_data.country' : 'البلد' , 'reach' : 'معدل الوصول' , 'engagement' :'التفاعل'})
