...
with col0:
    ...
    st.markdown("<h4 style='text-align: right; color: black; margin-top:40px;'>منشورات منسوبي وزارة الحج</h4>",
...
sheet_url5= 'https://docs.google.com/spreadsheets/d/18AR5cY7o6yYY_JndDSSAeo524NXKzk3RYGAOnKw2M0U/edit#gid=716631534'
url_manshorat_mansobi = sheet_url5.replace('/edit#gid=' , '/export?format=csv&gid=')

sheet_url6= 'https://docs.google.com/spreadsheets/d/1sPP_OcuxxHneGykXZxd68V4c_dCl2i7-hONOngyo8NU/edit#gid=866306760'
url_mansobi_sent = sheet_url6.replace('/edit#gid=' , '/export?format=csv&gid=')
...
def get_data2():
    dataframe = pd.read_csv(url_manshorat_mansobi)
    dataframe2 = pd.read_csv(url_mansobi_sent)
    # time.sleep(4)
    return dataframe , dataframe2
df, df_sentiment = get_data2()
